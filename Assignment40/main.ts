...
interface Album{
    ...
    function make_album(artist_name:string , Title:string, track?:number): Album {
     ...
     const album_2 = make_album("Waleed" , "Dream11" , 23)
     const album_3 = make_album("Ali", "Dream11" , 11)
     const album_4 = make_album("Omais","Dream11" , 25)
